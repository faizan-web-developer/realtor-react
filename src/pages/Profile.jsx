    ...
    <>
      <section className='mx-auto max-w-6xl flex justify-center items-center flex-col'>
        ...
        <div className='w-full md:w-[50%] mt-6 px-3'>
          <form>
            {/*NAME INPUT*/}
            <input type="text" defaultValue={name} id="name" disabled className='mb-6 w-full px-4 py-2 text-xl text-gray-700 bg-white border-gray-300 rounded transition ease-in-out'/>
            {/*EMAIL INPUT*/}
