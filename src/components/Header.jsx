        ...
        <header className='flex justify-between items-center px-3 mx-auto max-w-6xl'>
            ...
            <div>
                <ul className='flex space-x-10'>
                    ...
                    <li className={`cursor-pointer font-semibold py-3 text-sm text-gray-400 border-b-[3px] border-b-transparent ${selectedPath("/sign-in") && "text-black border-b-red-500"}`} onClick={()=>navigate("/sign-in")}>Sign In</li>
                </ul>
            </div>
        </header>
    </div>
